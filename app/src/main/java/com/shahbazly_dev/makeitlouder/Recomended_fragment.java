...
public class Recomended_fragment extends Fragment {
    ...
    public static Recomended_fragment newInstance(int page, String title) {
        Recomended_fragment recomended_fragment = new Recomended_fragment();
        Bundle args = new Bundle();
        args.putInt("Int", page);
        args.putString("Title", title);
        recomended_fragment.setArguments(args);
        return recomended_fragment;
    }

    private void prepareSongData() {
        mLVCircularCD.startAnim();
        final VKRequest songsRequest = VKApi.audio().getRecommendations();
